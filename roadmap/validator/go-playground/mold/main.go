...
type User struct {
	...
	Email   string            `mod:"trim,default=vicktor@gmail.com"      validate:"required,email"        scrub:"emails"`
...
func main() {
	...
	util.DumpPretty("Decoded user", user)
	...
	util.DumpPretty("Conformed User", user)
	...
	util.DumpPretty("Scrubbed User", user)
}
